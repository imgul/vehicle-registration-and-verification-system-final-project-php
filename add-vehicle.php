                            ...
                            <form class="user needs-validation" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name="fname" type="text" class="form-control form-control-user" id="exampleFirstName" placeholder="Vehicle Number" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input name="lname" type="text" class="form-control form-control-user" id="exampleLastName" placeholder="Vehicle Company Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <select class="form-select" aria-label="Select Vehicle Color">
