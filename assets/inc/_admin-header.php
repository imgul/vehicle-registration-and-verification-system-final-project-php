...
<main id="container">
    <div id="sidebar">
        ...
        <ul id="options">
            <li class="option <?php if ($page == 'dashboard') {
                                    echo 'active';
                                } ?>">
            ...
            <li class="option <?php if ($page == 'bus') {
                                    echo 'active';
                                } ?>">
                <a href="./bus.php">
            ...
            <li class="option <?php if ($page == 'route') {
                                    echo 'active';
                                } ?>">
                <a href="./route.php">
            ...
            <li class="option <?php if ($page == 'customer') {
                                    echo 'active';
                                } ?>">
                <a href="./customer.php">
            ...
            <li class="option <?php if ($page == 'booking') {
                                    echo 'active';
                                } ?>">
                <a href="./booking.php">
            ...
            <li class="option <?php if ($page == 'seat') {
                                    echo 'active';
                                } ?>">
                <a href="./seat.php">
            ...
            <li class="option <?php if ($page == 'signup') {
                                    echo 'active';
                                } ?>">
                <a href="./signup.php">
